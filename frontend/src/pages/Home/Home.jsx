...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* SECTION: CLASSES */}
      <div id="classes" className="classes-section">
        <div className="classes-header">
          <div>
            <h2 className="classes-title">
              Kelas <span className="classes-title-accent">Tersedia</span>
            </h2>
            <p className="classes-subtitle">Pilih kelas dan mulai latihanmu.</p>
          </div>
        </div>
